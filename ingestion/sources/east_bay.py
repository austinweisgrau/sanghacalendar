...
CENTERS = {
    ...
    "shambhala_sf": Center(
        ...
        tradition=Tradition.TIBETAN,
        notes="Shambhala Buddhist tradition (Chögyam Trungpa lineage). Biweekly Beginners Night (2nd & 4th Wed 7pm), 3rd Saturday 9am, 1st & 2nd Sunday 10am (online). No iCal — manually seeded.",
    ),
