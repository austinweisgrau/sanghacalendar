#!/usr/bin/env bun
/**
 * One-time Portland Phase 3 iCal ingest.
 * Seeds Dharma Rain Zen Center and Kagyu Changchub Chuling (KCC).
...
const CENTERS = {
  dharma_rain: {
    id: "dharma_rain", name: "Dharma Rain Zen Center",
    url: "https://dharma-rain.org",
    address: "8500 NE Siskiyou St", city: "Portland", state: "OR", zip: "97220",
    neighborhood: "Roseway / Northeast Portland",
    lat: 45.5508, lng: -122.5946, tradition: "zen",
  },
  kagyu_changchub_chuling: {
    id: "kagyu_changchub_chuling", name: "Kagyu Changchub Chuling",
    url: "https://kcc.org",
    address: "4936 NE Skidmore St", city: "Portland", state: "OR", zip: "97218",
    neighborhood: "Beaumont-Wilshire / Northeast Portland",
    lat: 45.5579, lng: -122.6134, tradition: "tibetan",
  },
};

const ICAL_FEEDS = {
  dharma_rain: { url: "https://dharma-rain.org/events/?ical=1", filterToSits: true },
  kagyu_changchub_chuling: { url: "https://kcc.org/calendar/month/?ical=1", filterToSits: true },
};
...
const SIT_KEYWORDS = [
  ...
  "open house","evening sit","morning sit","weekly",
];

const EXCLUDE_TITLE_KEYWORDS = [
  "workshop","class","course","training","webinar","conference","fundraiser","social",
  "party","festival","concert","performance","art show","exhibit","film","movie",
  "volunteer","cleanup","fundraising","gala","ceremony","graduation","orientation",
  "meeting","board","committee","staff","volunteer","administrative",
];
